 ...
 * `@headlessuiclone/tailwindcss` plugin has to compile to a CommonJs file. This works great, however
 ...
 * exported type. This allows us to use the `@headlessuiclone/tailwindcss` plugin and have types in a
